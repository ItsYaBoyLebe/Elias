  ...
  nl: {
    ...
    pillars: {
      ...
      items: [
        {
          icon: "tree",
          title: "Verkoop Bosbouwmachines",
          body: "Professionele machines voor boomverzorgers, bosbouwaannemers en groenspecialisten. Persoonlijk advies, eerlijke prijzen.",
          cta: "Bekijk aanbod",
          link: "products.html"
        },
        {
          ...
          body: "Herstelling, onderhoud en mobiele interventies voor tuin- en bosbouwmachines. Snel weer aan de slag.",
          cta: "Ontdek service",
          link: "service.html"
        },
        {
          icon: "car",
          title: "Custom Cars & Oldtimers",
          body: "Gespecialiseerd in BMW en Volkswagen: restauratie, revisie en custom builds voor wie houdt van klassiekers met karakter.",
          cta: "Meer weten",
    ...
    cta: {
      title: "Klaar om samen aan de slag te gaan?",
      body: "Vraag een demo aan, plan een onderhoud in, of bespreek uw oldtimer project.",
    ...
    contact: {
      ...
      intro: "Een vraag over een machine, een herstelling inplannen, of een oldtimer project bespreken? Vul het formulier in of bel rechtstreeks.",
  ...
  en: {
    ...
    pillars: {
      ...
      items: [
        {
          icon: "tree",
          title: "Forestry Machinery Sales",
          body: "Professional machines for arborists, forestry contractors and landscapers. Honest advice, fair prices.",
          cta: "View range",
          link: "products.html"
        },
        {
          ...
          body: "Repair, maintenance and mobile callouts for garden and forestry equipment. Back to work, fast.",
          cta: "Explore service",
          link: "service.html"
        },
        {
